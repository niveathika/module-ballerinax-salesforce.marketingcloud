...
public isolated client class Client {
    ...
    public isolated function init(ConnectionConfig config, string subDomain) returns error? {
        ...
        OAuth2ClientCredentialsGrantConfig updatedAuth = config.auth;
        updatedAuth.tokenUrl = tokenUrl;

        http:ClientConfiguration httpClientConfig = {auth: updatedAuth, httpVersion: config.httpVersion, http1Settings: config.http1Settings, http2Settings: config.http2Settings, timeout: config.timeout, forwarded: config.forwarded, followRedirects: config.followRedirects, poolConfig: config.poolConfig, cache: config.cache, compression: config.compression, circuitBreaker: config.circuitBreaker, retryConfig: config.retryConfig, cookieConfig: config.cookieConfig, responseLimits: config.responseLimits, secureSocket: config.secureSocket, proxy: config.proxy, socketConfig: config.socketConfig, validation: config.validation, laxDataBinding: config.laxDataBinding};
